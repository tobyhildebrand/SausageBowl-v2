...
$isHeadToHeadActive = $currentRoute === '/head-to-head';
    ...
    <header class="site-header">
        <div class="site-header__inner">
            ...
            <nav class="site-nav" aria-label="Main navigation">
                ...
                <a href="/index.php?r=head-to-head" class="<?= $isHeadToHeadActive ? 'is-active' : '' ?>" aria-current="<?= $isHeadToHeadActive ? 'page' : 'false' ?>">Head-to-Head</a>
